...
# Description
This pack was created to recreate the gameframe of late 2006, when hunter was released. I spent a lot of time searching old references and trying to fit the old interface style with the current so it looks as close to the original style as possible.

**If you're looking for 2006 Resizable Mode, check out my other pack** [Here](https://github.com/melkypie/resource-packs/tree/pack-2006)
...
# Features
 ...
 - 1:1 Icon alignment
 - 1:1 Icon shading
 - Reworked tabs for all interfaces to match the old 2006 style

![Features](https://i.imgur.com/TX9G9Zs.png)
![Features](https://i.imgur.com/IGz7Rtl.png)
![Features](https://i.imgur.com/NvPSkUe.png)
![Features](https://i.imgur.com/mWqCdp7.png)
![Features](https://i.imgur.com/1yPKoST.png)


**In order to correctly use fixed mode theres a couple steps required:**
