...
public enum WidgetOverride
{
	...
	GE_BORDER_OFFER_BUY_OFFER_FULL_INNER(GE_OFFERS_SETUP_INIT, 0x5a5245, InterfaceID.GRAND_EXCHANGE, 25, 16),
	GE_BORDER_OFFER_BUY_OFFER_FULL_OUTER(GE_OFFERS_SETUP_INIT, 0x383023, InterfaceID.GRAND_EXCHANGE, 25, 17),
	GE_BORDER_OFFER_BUY_OFFER_BOTTOM_INNER(GE_OFFERS_SETUP_INIT, 0x5a5245, InterfaceID.GRAND_EXCHANGE, 25, 18),
	GE_BORDER_OFFER_BUY_OFFER_BOTTOM_OUTER(GE_OFFERS_SETUP_INIT, 0x383023, InterfaceID.GRAND_EXCHANGE, 25, 19),
	GE_BORDER_OFFER_CHOOSE_ITEM_INNER(GE_OFFERS_SETUP_INIT, 0x5a5245, InterfaceID.GRAND_EXCHANGE, 25, 25),
	GE_BORDER_OFFER_CHOOSE_ITEM_OUTER(GE_OFFERS_SETUP_INIT, 0x383023, InterfaceID.GRAND_EXCHANGE, 25, 26),
	GE_BORDER_OFFER_QUANTITY_INNER(GE_OFFERS_SETUP_INIT, 0x5a5245, InterfaceID.GRAND_EXCHANGE, 25, 28),
	GE_BORDER_OFFER_QUANTITY_OUTER(GE_OFFERS_SETUP_INIT, 0x383023, InterfaceID.GRAND_EXCHANGE, 25, 29),
