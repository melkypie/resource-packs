...
public enum WidgetOverride
{
	...
	GE_CHATBOX_BUY_SEARCH_BORDER_INNER(GE_OFFERS_SETUP_INIT, 0x463214, InterfaceID.GRAND_EXCHANGE, 51, -1),
	GE_CHATBOX_BUY_SEARCH_BORDER_OUTER(GE_OFFERS_SETUP_INIT, 0x463214, InterfaceID.GRAND_EXCHANGE, 52, -1),
	GE_CHATBOX_BUY_SEARCH_BACKGROUND(GE_OFFERS_SETUP_INIT, 0x463214, InterfaceID.GRAND_EXCHANGE, 50, -1),
